...
-- Tiempo de generación: 02-11-2020 a las 11:54:05
...
-- Procedimientos
--
CREATE DEFINER=`labmia`@`%` PROCEDURE `AsignarCursoRegistrar` (IN `cui` VARCHAR(13), IN `nombres` VARCHAR(30), IN `apellidos` VARCHAR(30), IN `correo` VARCHAR(60), IN `contrasena` VARCHAR(25), IN `telefono` VARCHAR(12), IN `paisOrigen` VARCHAR(30), IN `fechaNacimiento` VARCHAR(12), IN `idCurso` BIGINT(200), IN `fechaIns` DATE)  NO SQL
BEGIN
	start transaction;
...
CREATE DEFINER=`labmia`@`%` PROCEDURE `BuscarCursosPor` (IN `ID` INT)  BEGIN
	SELECT * FROM CURSO JOIN DETALLE_CURSO ON CURSO.idCurso= DETALLE_CURSO.idCurso WHERE CURSO.idCurso = ID;
END$$

CREATE DEFINER=`labmia`@`5` PROCEDURE `editarCurso` (IN `nombre` VARCHAR(30), IN `idArea` INT, IN `duracion` INT, IN `MONTO` FLOAT, IN `DESCRIPCION` VARCHAR(500), IN `IDCURSO` INT, IN `FECHAIN` DATE, IN `FECHAFIN` DATE, IN `DPIPROFE` CHAR(13))  BEGIN
...
CREATE DEFINER=`labmia`@`%` PROCEDURE `inscritosPorCurso` ()  NO SQL
BEGIN
...
(21, '2020-11-01', '2020-11-27', '3165111655595'),
(21, '2020-11-01', '2020-11-27', '3165111655595'),
(21, '2020-11-01', '2020-11-27', '3165111655595');
...
INSERT INTO `INSCRIPCION` (`DPIEstudiante`, `idCurso`, `idInscripcion`, `estadoCurso`, `fechaInscripcion`, `nota`) VALUES
('4656494847231', 10, 100, 'Finalizado', '2020-07-23', 100),
('7743745233321', 12, 101, 'Sin finalizar', '2020-07-11', 0),
('1896249867175', 20, 102, 'Finalizado', '2020-01-12', 0),
('9334296295774', 21, 103, 'Sin finalizar', '2020-03-01', 0),
('5251898795196', 15, 104, 'Finalizado', '2020-01-15', 0),
('8876977871259', 10, 105, 'Sin finalizar', '2020-07-01', 0),
('2424663776274', 12, 106, 'Finalizado', '2020-07-24', 0),
('7201521865755', 20, 107, 'Sin finalizar', '2020-01-16', 0),
('8112458659379', 21, 108, 'Finalizado', '2020-02-23', 0),
('2673178712142', 15, 109, 'Finalizado', '2020-04-04', 0),
('8688308288682', 10, 110, 'Finalizado', '2020-07-10', 0),
('3362249215113', 12, 111, 'Sin finalizar', '2020-03-20', 0),
('4978274531379', 20, 112, 'Finalizado', '2020-08-07', 0),
('9853067544943', 21, 113, 'Sin finalizar', '2020-06-16', 0),
('6621473859294', 15, 114, 'Finalizado', '2020-04-02', 0),
('8012504195721', 10, 115, 'Finalizado', '2020-04-15', 0),
('3519985971756', 12, 116, 'Finalizado', '2020-02-29', 0),
('5324821702584', 20, 117, 'Sin finalizar', '2020-04-23', 0),
('8518106685845', 21, 118, 'Finalizado', '2020-04-17', 0),
('8505332448329', 15, 119, 'Sin finalizar', '2020-05-18', 0),
('8412682708922', 10, 120, 'Finalizado', '2020-08-19', 0),
('3166847164968', 12, 121, 'Sin finalizar', '2020-01-18', 0),
('4874727879562', 20, 122, 'Finalizado', '2020-05-02', 0),
('3785606711595', 21, 123, 'Sin finalizar', '2020-08-29', 0),
('7916067422954', 15, 124, 'Finalizado', '2020-01-05', 0),
('2794293466135', 10, 125, 'Finalizado', '2020-01-22', 0),
('5873195343149', 12, 126, 'Finalizado', '2020-01-06', 0),
('6029073589375', 20, 127, 'Sin finalizar', '2020-09-03', 0),
('4286454125131', 21, 128, 'Finalizado', '2020-01-25', 0),
('7055223514855', 15, 129, 'Sin finalizar', '2020-04-25', 0),
('7411491686688', 10, 130, 'Finalizado', '2020-07-24', 0),
('7869188725423', 12, 131, 'Finalizado', '2020-04-14', 0),
('3765822016389', 20, 132, 'Finalizado', '2020-08-28', NULL),
('5161815689159', 21, 133, 'Sin finalizar', '2020-02-20', NULL),
('3124416569842', 15, 134, 'Finalizado', '2020-09-07', NULL),
('4222666404678', 10, 135, 'Sin finalizar', '2020-06-11', NULL),
('4438874842227', 12, 136, 'Finalizado', '2020-09-23', NULL),
('8673817033762', 20, 137, 'Sin finalizar', '2020-03-10', NULL),
('1612164249924', 21, 138, 'Finalizado', '2020-06-21', NULL),
('7324725432528', 15, 139, 'Sin finalizar', '2020-02-20', NULL),
('1782502339663', 10, 140, 'Finalizado', '2020-01-31', NULL),
('3753834438624', 12, 141, 'Finalizado', '2020-02-25', NULL),
('4027531222546', 20, 142, 'Finalizado', '2020-06-23', NULL),
('6678315852275', 21, 143, 'Sin finalizar', '2020-09-23', NULL),
('3716125171883', 15, 144, 'Finalizado', '2020-01-15', NULL),
('7099277915696', 10, 145, 'Sin finalizar', '2020-09-16', NULL),
('5881997513429', 12, 146, 'Finalizado', '2020-08-20', NULL),
('7194562786283', 20, 147, 'Finalizado', '2020-06-04', NULL),
('7666181043141', 21, 148, 'Finalizado', '2020-03-07', NULL),
('8721159019482', 15, 149, 'Sin finalizar', '2020-07-02', NULL),
('2481797768231', 10, 150, 'Finalizado', '2020-04-21', NULL),
('6267212025821', 12, 151, 'Sin finalizar', '2020-03-22', NULL),
('7533516494879', 20, 152, 'Finalizado', '2020-09-01', NULL),
('1245142205268', 21, 153, 'Sin finalizar', '2020-06-12', NULL),
('6503708633545', 15, 154, 'Finalizado', '2020-04-20', NULL),
('6438738614741', 10, 155, 'Sin finalizar', '2020-03-29', NULL),
('3936123466855', 12, 156, 'Finalizado', '2020-09-22', NULL),
('8517336186884', 20, 157, 'Finalizado', '2020-07-11', NULL),
('9029249139433', 21, 158, 'Finalizado', '2020-09-02', NULL),
('8278595896198', 15, 159, 'Sin finalizar', '2020-01-04', NULL),
('9525141272734', 10, 160, 'Finalizado', '2020-09-06', NULL),
('3173889023845', 12, 161, 'Sin finalizar', '2020-08-29', NULL),
('9041676992762', 20, 162, 'Finalizado', '2020-05-20', NULL),
('8189398836714', 21, 163, 'Finalizado', '2020-06-24', NULL),
('6239264731714', 15, 164, 'Finalizado', '2020-09-24', NULL),
('4336415935114', 10, 165, 'Sin finalizar', '2020-05-09', NULL),
('6421015204948', 12, 166, 'Finalizado', '2020-04-16', NULL),
('6952827964613', 20, 167, 'Sin finalizar', '2020-01-21', NULL),
('3482468796238', 21, 168, 'Finalizado', '2020-04-21', NULL),
('4343705962974', 15, 169, 'Sin finalizar', '2020-08-22', NULL),
('5656462744969', 10, 170, 'Finalizado', '2020-08-10', NULL),
('4956992981976', 12, 171, 'Sin finalizar', '2020-08-18', NULL),
('4783141174172', 20, 172, 'Finalizado', '2020-07-21', NULL),
('8689616635572', 21, 173, 'Finalizado', '2020-07-06', NULL),
('5635525352854', 15, 174, 'Finalizado', '2020-06-23', NULL),
('8479631904862', 10, 175, 'Sin finalizar', '2020-01-03', NULL),
('4863431337833', 12, 176, 'Finalizado', '2020-09-30', NULL),
('8285387785399', 20, 177, 'Sin finalizar', '2020-09-22', NULL),
('6599622212522', 21, 178, 'Finalizado', '2020-02-11', NULL),
('4312197233281', 15, 179, 'Finalizado', '2020-07-15', NULL),
('1094444029478', 10, 180, 'Sin finalizar', '2020-07-10', NULL),
('6864916904472', 12, 181, 'Finalizado', '2020-04-22', NULL),
('4171244858185', 20, 182, 'Sin finalizar', '2020-07-31', NULL),
('9211127436756', 21, 183, 'Finalizado', '2020-06-14', NULL),
('3749962798716', 15, 184, 'Sin finalizar', '2020-10-01', NULL),
('7764111691624', 10, 185, 'Finalizado', '2020-07-01', NULL),
('9334707235336', 12, 186, 'Finalizado', '2020-06-30', NULL),
('6121145471117', 20, 187, 'Finalizado', '2020-06-14', NULL),
('9592724974729', 21, 188, 'Sin finalizar', '2020-06-19', NULL),
('6547095719627', 15, 189, 'Finalizado', '2020-09-20', NULL),
('7227378379449', 10, 190, 'Sin finalizar', '2020-02-22', NULL),
('7915156396923', 12, 191, 'Finalizado', '2020-04-11', NULL),
('2183239792732', 20, 192, 'Finalizado', '2020-07-11', NULL),
('3406981042422', 21, 193, 'Sin finalizar', '2020-04-20', NULL),
('5836513518265', 15, 194, 'Finalizado', '2020-08-30', NULL),
('9519253166169', 10, 195, 'Sin finalizar', '2020-04-13', NULL),
('1634793851838', 12, 196, 'Finalizado', '2020-09-25', NULL),
('8825706045463', 20, 197, 'Sin finalizar', '2020-05-19', NULL),
('2791319988362', 21, 198, 'Finalizado', '2020-03-18', NULL),
('8861589664797', 15, 199, 'Finalizado', '2020-03-03', NULL),
('5417786901685', 10, 200, 'Finalizado', '2020-04-26', NULL),
('9954105586643', 12, 201, 'Sin finalizar', '2020-09-26', NULL),
('', 21, 209, 'Sin Finalizar', '2020-11-02', NULL),
('', 21, 210, 'Sin Finalizar', '2020-11-02', NULL),
('4656494847231', 21, 211, 'Sin Finalizar', '2020-11-02', NULL);
